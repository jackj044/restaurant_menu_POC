...
class HomeDetailsWeb extends ConsumerStatefulWidget {
  const HomeDetailsWeb({Key? key}) : super(key: key);

  @override
  ConsumerState<HomeDetailsWeb> createState() => _HomeWebState();
}

class _HomeWebState extends ConsumerState<HomeDetailsWeb> {
  ///Init
  @override
  void initState() {
    super.initState();
